    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar" >
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="classCheckbox">Graduation</label>
            </div>
            <!-- Rent Checkbox -->
            <div class="form-check">
        ...
        <div class="col-md-10">
            ...
            <div id="filterChips" class="mb-3" style="display: none;">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <!-- Class Filter Chips -->
                    <button class="btn btn-outline-secondary btn-sm" data-class="1">Under-graduation</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="2">Post-graduation</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="3">Phd</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="4">Diploma</button>
