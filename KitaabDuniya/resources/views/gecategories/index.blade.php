    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar" >
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="classCheckbox">Categories</label>
            </div>
            <!-- Rent Checkbox -->
            <div class="form-check">
            ...
            <input type="range" class="form-range" id="priceRange" min="50" max="5000" step="50">
        ...
        <div class="col-md-10">
            ...
            <div id="filterChips" class="mb-3" style="display: none;">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <!-- Class Filter Chips -->
                    <button class="btn btn-outline-secondary btn-sm" data-class="1">📖 Novels & Stories</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="1">💖 Romance Books</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="1">👑 Biographies & Autobiographies</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="2">🧠 Psychology & Philosophy</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="3">🌍 Travel & Adventure</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="4">🥗 Health & Fitness</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="4">💼 Business & Finance</button>
                    <button class="btn btn-outline-secondary btn-sm" data-class="4">📚 Self-Help & Motivational</button>
