...
<nav class="navbar navbar-expand-lg custom-navbar py-0 px-10">
    ...
    <div class="form-container">
        <h2>Book Listing</h2>
        <p>Graduation /<a href="/sell"> change</a></p>
        ...
        <form>
            ...
            <!-- Category -->
            <div class="mb-3">
    <label for="class" class="form-label">Select Year</label>
    <select class="form-control" id="class" required>
        <option value="">choose year</option>
        <option value="class1">1st year</option>
        <option value="class2">2nd year</option>
        <option value="class3">3rd year</option>
        <option value="class3">4th year</option>
    </select>
</div>
